...
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "https://eyespire.vercel.app", allowCredentials = "true", methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE, RequestMethod.OPTIONS})
